    ...
    <section id="dimensions" class="py-16 bg-white">
        <div class="container mx-auto px-4">
            ...
            <div class="flex flex-wrap justify-center mb-8">
                <button id="tab-player-exp" class="tab-btn tab-active px-6 py-2 mx-2 mb-4 rounded-full transition-all duration-300">
                    玩家体验演进
                </button>
                <button id="tab-emotion" class="tab-btn px-6 py-2 mx-2 mb-4 rounded-full transition-all duration-300">
                    情绪曲线
                </button>
                <button id="tab-need" class="tab-btn px-6 py-2 mx-2 mb-4 rounded-full transition-all duration-300">
                    需求满足
                </button>
                <button id="tab-relation" class="tab-btn px-6 py-2 mx-2 mb-4 rounded-full transition-all duration-300">
                    感情弧线
                </button>
            </div>
            
            <!-- 选项卡内容 -->
            <div class="tab-content" id="content-player-exp">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                    <div class="order-2 md:order-1">
                        <h4 class="text-2xl font-bold mb-4">玩家体验演进</h4>
                        <ul class="space-y-4">
                            <li class="flex items-start">
                                ...
                                <div>
                                    <h5 class="font-bold text-lg">初见：视觉刺激→探索欲激活</h5>
                                    <p class="text-gray-600">通过独特的视觉设计和任务异常，吸引玩家的注意力，激发探索欲望。</p>
                                </div>
                            </li>
                            <li class="flex items-start">
                                <div class="w-10 h-10 rounded-full bg-primary flex items-center justify-center mr-4 flex-shrink-0">
                                ...
                                <div>
                                    <h5 class="font-bold text-lg">再见：剧情反转→世界观沉浸</h5>
                                    <p class="text-gray-600">通过剧情的意外转折和新线索的发现，引导玩家深入了解游戏世界观。</p>
                                </div>
                            </li>
                            <li class="flex items-start">
                                <div class="w-10 h-10 rounded-full bg-primary flex items-center justify-center mr-4 flex-shrink-0">
                                ...
                                <div>
                                    <h5 class="font-bold text-lg">成长：合作战斗→保护欲形成</h5>
                                    <p class="text-gray-600">通过合作任务和战斗，建立玩家与角色之间的情感纽带，激发保护欲。</p>
                                </div>
                            </li>
                            <li class="flex items-start">
                                <div class="w-10 h-10 rounded-full bg-primary flex items-center justify-center mr-4 flex-shrink-0">
                                ...
                                <div>
                                    <h5 class="font-bold text-lg">高潮：情感抉择→亲密关系确认</h5>
                                    <p class="text-gray-600">通过关键的情感抉择，深化玩家与角色之间的关系，达到情感高潮。</p>
                                </div>
                            </li>
                            <li class="flex items-start">
                                <div class="w-10 h-10 rounded-full bg-primary flex items-center justify-center mr-4 flex-shrink-0">
                                ...
                                <div>
                                    <h5 class="font-bold text-lg">循环：日常互动→归属感建立</h5>
                                    <p class="text-gray-600">通过日常任务和互动，建立玩家的归属感和长期参与意愿。</p>
                                </div>
                            </li>
                            <li class="flex items-start">
                                <div class="w-10 h-10 rounded-full bg-primary flex items-center justify-center mr-4 flex-shrink-0">
                                ...
                                <div>
                                    <h5 class="font-bold text-lg">结局：宿命共鸣→情感闭环</h5>
                                    <p class="text-gray-600">通过多样化的结局，满足玩家的情感需求，完成整个体验的情感闭环。</p>
                                </div>
                            </li>
                        </ul>
                    </div>
                    <div class="order-1 md:order-2 bg-neutral rounded-xl p-6 shadow-lg">
                        <div class="mermaid">
                            graph LR
                                初见阶段 --> 再见阶段 --> 成长阶段 --> 高潮阶段 --> 循环体验 --> 结局阶段
                                classDef process fill:#FFD1DC,stroke:#FF69B4,stroke-width:2px
                        </div>
                    </div>
                </div>
            </div>
            
            <div class="tab-content hidden" id="content-emotion">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                    <div class="order-2 md:order-1">
                        <h4 class="text-2xl font-bold mb-4">情绪曲线</h4>
                        <p class="text-gray-600 mb-6">情绪曲线呈现了玩家在整个体验过程中的情感变化，每个阶段都有独特的情绪波动和关键转折点。</p>
                        <div class="bg-neutral rounded-lg p-6 shadow-md">
                            <div class="mermaid">
                                graph TB
                                    subgraph 进程
                                        A[初见] --> B[再见] --> C[成长] --> D[高潮] --> E[循环] --> F[结局]
                                    end

                                    subgraph 情感强度
                                        A_intensity[30%]:::intensity
                                        B_intensity[45%]:::intensity
                                        C_intensity[65%]:::intensity
                                        D_intensity[95%]:::peak_intensity
                                        E_intensity[75%]:::intensity
                                        F_intensity[60%]:::intensity
                                    end
                                    ...
                                    %% 强度曲线
                                    A_intensity -.-> B_intensity -.-> C_intensity -.-> D_intensity -.-> E_intensity -.-> F_intensity

                                    classDef intensity fill:#FFD1DC,stroke:#FF69B4,width:20px
                                    classDef peak_intensity fill:#FF69B4,stroke:#C71585,width:25px
                                    classDef emo fill:#FFF0F5,stroke:#FF69B4
                                    class A,B,C,D,E,F fill:#FFF,stroke:#333
                            </div>
                        </div>
                    </div>
                    <div class="order-1 md:order-2 bg-neutral rounded-xl p-6 shadow-lg">
                            ...
                            <table class="w-full">
                                <thead>
                                    <tr class="bg-primary/30">
                                        ...
                                        <th class="py-3 px-4 text-left">情绪演进</th>
                                        <th class="py-3 px-4 text-left">关键场景</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr class="border-b">
                                        <td class="py-3 px-4 font-medium">初见阶段</td>
                                        <td class="py-3 px-4">😯（惊讶/好奇）→ 🎢（刺激/紧张）</td>
                                        <td class="py-3 px-4">追逐战和肢体接触</td>
                                    </tr>
                                    <tr class="border-b">
                                        <td class="py-3 px-4 font-medium">再见阶段</td>
                                        <td class="py-3 px-4">🕵️（侦探感）→ 😏（被撩拨的兴奋）</td>
                                        <td class="py-3 px-4">调查尸体和骨剑威胁</td>
                                    </tr>
                                    <tr class="border-b">
                                        <td class="py-3 px-4 font-medium">成长阶段</td>
                                        <td class="py-3 px-4">🤝（合作）→ 😢（感动）</td>
                                        <td class="py-3 px-4">断后牺牲和秘密揭露</td>
                                    </tr>
                                    <tr class="border-b">
                                        <td class="py-3 px-4 font-medium">高潮阶段</td>
                                        <td class="py-3 px-4">💔（心痛）→ 💘（激情）</td>
                                        <td class="py-3 px-4">战损喂药和亲吻抉择</td>
                                    </tr>
                                    <tr class="border-b">
                                        <td class="py-3 px-4 font-medium">循环体验</td>
                                        <td class="py-3 px-4">😊（温馨）→ 🔄（期待）</td>
                                        <td class="py-3 px-4">日常陪伴和养成</td>
                                    </tr>
                                    <tr>
                                        <td class="py-3 px-4 font-medium">结局阶段</td>
                                        <td class="py-3 px-4">🎭（戏剧性）→ 😌（释然）或 😭（悲伤）</td>
                                        <td class="py-3 px-4">根据结局分支</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
            ...
            <div class="tab-content hidden" id="content-need">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                    <div class="order-2 md:order-1">
                        <h4 class="text-2xl font-bold mb-4">需求满足</h4>
                        <ul class="space-y-4">
                            <li class="flex items-start">
                                <div class="w-10 h-10 rounded-full bg-primary flex items-center justify-center mr-4 flex-shrink-0">
                                ...
                                <div>
                                    <h5 class="font-bold text-lg">初级：探索欲/新鲜感（初见）</h5>
                                    <p class="text-gray-600">通过新奇的场景和任务，满足玩家的探索欲望和对新鲜事物的好奇心。</p>
                                </div>
                            </li>
                            <li class="flex items-start">
                                <div class="w-10 h-10 rounded-full bg-primary flex items-center justify-center mr-4 flex-shrink-0">
                                ...
                                <div>
                                    <h5 class="font-bold text-lg">进阶：掌控感/求知欲（再见）</h5>
                                    <p class="text-gray-600">通过剧情线索和谜题解决，满足玩家对知识的渴望和对游戏世界的掌控感。</p>
                                </div>
                            </li>
                            <li class="flex items-start">
                                <div class="w-10 h-10 rounded-full bg-primary flex items-center justify-center mr-4 flex-shrink-0">
                                ...
                                <div>
                                    <h5 class="font-bold text-lg">核心：成长收益/羁绊感（成长）</h5>
                                    <p class="text-gray-600">通过角色成长和情感羁绊，满足玩家对成就感和情感连接的需求。</p>
                                </div>
                            </li>
                            <li class="flex items-start">
                                <div class="w-10 h-10 rounded-full bg-primary flex items-center justify-center mr-4 flex-shrink-0">
                                    <i class="fa fa-hand-pointer-o text-secondary"></i>
                                </div>
                                <div>
                                    <h5 class="font-bold text-lg">高潮：决策权/情感宣泄（血契共修）</h5>
                                    <p class="text-gray-600">通过关键决策和情感高潮场景，满足玩家对影响力和情感宣泄的需求。</p>
                                </div>
                            </li>
                            <li class="flex items-start">
                                <div class="w-10 h-10 rounded-full bg-primary flex items-center justify-center mr-4 flex-shrink-0">
                                ...
                                <div>
                                    <h5 class="font-bold text-lg">长期：养成陪伴（循环）</h5>
                                    <p class="text-gray-600">通过日常任务和养成系统，满足玩家对长期陪伴和角色发展的需求。</p>
                                </div>
                            </li>
                            <li class="flex items-start">
                                <div class="w-10 h-10 rounded-full bg-primary flex items-center justify-center mr-4 flex-shrink-0">
                                ...
                                <div>
                                    <h5 class="font-bold text-lg">终极：自我实现（救赎结局）</h5>
                                    <p class="text-gray-600">通过有意义的结局和角色发展，满足玩家对自我实现和故事共鸣的需求。</p>
                                </div>
                            </li>
                        </ul>
                    </div>
                    <div class="order-1 md:order-2 bg-neutral rounded-xl p-6 shadow-lg">
                        <div class="mermaid">
                            graph LR
                                探索欲+新鲜感 --> 求知欲+掌控感 --> 成长收益+羁绊感 --> 情感宣泄+决策权 --> 日常陪伴+养成 --> 自我实现+宿命共鸣
                                classDef need fill:#AFEEEE,stroke:#20B2AA,stroke-width:2px
                        </div>
                    </div>
                </div>
            </div>
            
    <div class="tab-content hidden" id="content-relation">
        <div class="mb-8 text-center">
            <h4 class="text-2xl font-bold mb-4">感情弧线</h4>
        </div>
        
        <!-- 双视角情感演进可视化 -->
        <div class="bg-neutral rounded-xl p-6 shadow-lg mb-8">
            <div class="mermaid">
                flowchart TD
                    %% 增强样式定义
                    classDef player fill:linear-gradient(to right, #E6F7FF, #B3E0FF),stroke:#1890FF,stroke-width:2px,rx:10,ry:10
                    classDef npc fill:linear-gradient(to right, #FFF0F0, #FFCCCC),stroke:#F5222D,stroke-width:2px,rx:10,ry:10
                    classDef connection stroke-dasharray:5,5,stroke-width:2px
                    
                    %% 双视角情感演进 - 仅保留此部分
                    subgraph 双视角情感演进
                        direction LR
                        subgraph 玩家视角
                            P1[警惕] --> P2[利用] --> P3[信任] --> P4[沉迷] --> P5[依恋] --> P6[共生]
                        end
                        subgraph NPC视角
                            N1[算计] --> N2[试探] --> N3[动摇] --> N4[沉溺] --> N5[依赖] --> N6[救赎]
                        end
                    end
                    
                    %% 添加视角间的情感连接
                    P1 -.->|初始戒备| N1:::connection
                    P2 -.->|互相试探| N2:::connection
                    P3 -.->|建立信任| N3:::connection
                    P4 -.->|情感爆发| N4:::connection
                    P5 -.->|深度依赖| N5:::connection
                    P6 -.->|命运共同体| N6:::connection
                    
                    class P1,P2,P3,P4,P5,P6 player
                    class N1,N2,N3,N4,N5,N6 npc
            </div>
        </div>
        
        <!-- 视角说明卡片 - 优化样式 -->
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
            <div class="bg-gradient-to-r from-blue-50 to-blue-100 p-6 rounded-xl shadow-md transform transition duration-300 hover:-translate-y-1 hover:shadow-lg border-l-4 border-blue-500">
                <h6 class="font-medium text-center mb-3 text-lg text-blue-700">玩家视角</h6>
                <p class="text-gray-700 text-center">警惕→利用→信任→沉迷→依恋→共生</p>
            </div>
            <div class="bg-gradient-to-r from-red-50 to-red-100 p-6 rounded-xl shadow-md transform transition duration-300 hover:-translate-y-1 hover:shadow-lg border-l-4 border-red-500">
                <h6 class="font-medium text-center mb-3 text-lg text-red-700">NPC视角</h6>
                <p class="text-gray-700 text-center">算计→试探→动摇→沉溺→依赖→救赎</p>
            </div>
        </div>
    </div>
        </div>
